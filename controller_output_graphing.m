...
error_off_th = model_pos_off_filtered - Curpos_off;
...
error_on_th = model_pos_on_filtered - Curpos_on;
...
%% Run info 
subplot(4,2,7);
nweights = 2; % MODIFY THIS BASED ON WEIGHTS USED!
material = 'Brake Pad'; % MODIFY THIS BASED ON MATERIAL USED!
